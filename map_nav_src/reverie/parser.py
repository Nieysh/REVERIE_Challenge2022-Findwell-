...
def parse_args():
    ...
    parser.add_argument('--clip_cfg_name', type=str, default='ViT-B/32')
    parser.add_argument('--new_data', action='store_true', default=True)
    parser.add_argument("--old_obj_setting", action='store_true', default=False)
