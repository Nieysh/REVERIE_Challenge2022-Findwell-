...
obj_ft_dim=2048 #old:768 new obj_feature:2048
...
CUDA_VISIBLE_DEVICES='0' python reverie/main_nav_obj.py $flag  \
      ...
      --new_data
#      --resume_optimizer \
#      --resume_file /data1/nys_new/VLN-DUET/datasets/REVERIE/exprs_map/finetune/new_data_7.25_continue_train/dagger-vitbase-seed.0/ckpts/best_val_unseen
#      --eval_first
